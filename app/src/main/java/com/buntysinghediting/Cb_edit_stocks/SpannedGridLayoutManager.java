...
public class SpannedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state){
        ...
        if (dy < 0) { // scrolling content down
            ...
            Log.d("SpannedGridManager ", "scrollVerticallyBy: "+(firstPositionOfLastRow - firstVisiblePosition));
            Log.d("SpannedGridManager ", "scrollVerticallyBy: "+(firstPositionOfLastRow));
            Log.d("SpannedGridManager ", "scrollVerticallyBy: "+(firstVisiblePosition));
